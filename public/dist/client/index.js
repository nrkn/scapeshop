...
import { canvasToImageData, fileImage, inputFile, imageToCanvas, loadImage, loadJson, loadText, parseXml } from './dom.js';
...
const q = Q(document);
// tools
const scapeGridInput = q('#scapeGrid');
const sourceImageInput = q('#sourceImage');
const customPixelMapperInput = q('#customPixelMapper');
const downloadOutputAnchor = q('#downloadOutput');
const loadGridDefault = q('#loadGridDefault');
const loadImageDefault = q('#loadImageDefault');
const loadOffsetDefault = q('#loadOffsetDefault');
const offsetXInput = q('#offsetX');
const offsetYInput = q('#offsetY');
const offsetXRange = q('#offsetXRange');
const offsetYRange = q('#offsetYRange');
const pixelMapperSelect = q('#pixelMapper');
const showAllVoxelsInput = q('#showAllVoxels');
...
const start = async () => {
    ...
    const grid = await loadJson('./data/grid-large.json');
    d.info('start');
...
customPixelMapperInput.addEventListener('change', async () => {
    ...
    if (typeof pixelMapper !== 'function')
        throw Error('Expected pixelMapper function export');
