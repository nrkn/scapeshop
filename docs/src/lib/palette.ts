import { Tuple3, Tuple4 } from '../types.js'
...
export const paletteRgbaTuples: Tuple4[] = []
...
export const paletteHslaTuples: Tuple4[] = paletteRgbaTuples.map(([r, g, b, a]) => [...rgbToHsl(r, g, b), a])

export const closestPaletteIndex = ( rgba: Tuple4, hueWeight = 2, satWeight = 1, lumWeight = 1 ) => {
  let index = 0
...
export const closestHueIndex = ( rgba: Tuple4 ) => {
  let index = 0
  let delta = Number.MAX_SAFE_INTEGER
